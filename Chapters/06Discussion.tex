...
\section{Prediction of the future DOA based on the rate of change}
The estimated DOA values could be used to predict the future DOA of the detected drone. In the current design this is not implemented. It could however be achieved by running an additional ML script that could be trained based on the data gathered while system runs. It may however come with additional lag in the system, if the training data load would be too heavy. 
...
\section{System Integration and Software Environment}
