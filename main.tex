...
\noindent  \textcolor{gray}{\large Mateusz Dabrowa, Andreas Jortveit, Brage Solem} \\
\vspace{1cm}

\noindent \textbf{\Large Acoustic-Visual Drone Detection} \\
\vspace{0.5cm}

\noindent {\large } \\ % HUSK Å ENDRE


\vspace{7cm}
\noindent Bachelor's thesis in Automation and Intelligent systems \\
